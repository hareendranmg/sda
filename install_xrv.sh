...
exar_dir="/home/root/sda/xr17-lnx2.6.32-and-newer-pak"
...
if ls /dev/ttyXR* 2>/dev/null; then
  ...
  # Open and close the ports to workaround the issue of the ports not being accessible in c
  # python3 /home/root/open_and_close_xr_ports.py
