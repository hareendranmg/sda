...
int main(int argc, char *argv[])
{
    ...
    if (access(outputFileName, F_OK) != -1)
    {
        ...
        // eg. if the file name is /home/root/sda/data.csv, then rename to /home/root/sda/data_old_20201231_235959.csv
        ...
        snprintf(old_file_name, sizeof(old_file_name), "%s_old_%s%s", outputFileName, old_file_name, file_ext);
